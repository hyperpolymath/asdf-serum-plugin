...
:url-repo: https://github.com/hyperpolymath/asdf-serum-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-serum-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-serum-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-serum-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Serum] versions.
...
Serum is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Serum versions per project

|**Project Isolation**
|Pin Serum per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Serum version
...
=== Installing Serum Versions

[source,bash]
----
asdf list all serum
asdf install serum latest
asdf install serum 0.1.0
----
...
[source,bash]
----
asdf global serum 0.1.0
asdf local serum 0.1.0
asdf current serum
serum --version
----
...
* Ensure `serum` is on PATH after installation.
* Verify the installed version with `serum --version`.
